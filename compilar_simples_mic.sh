...
flagm="-module ./"
flag="-O3 -mmic -align array64byte -opt-assume-safe-padding -g -debug inline-debug-info"
...
./mic_native_nacad.sh 0 ${nome_exec}_$nome_pasta
exit 
